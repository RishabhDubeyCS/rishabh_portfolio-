...
export default function ScrollStory() {
  return (
    <div className="relative">
      {/* SECTION 1 */}
      <section className="text-white h-screen w-full bg-slate-950 grid place-content-center sticky top-0 overflow-hidden z-0">
      ...
      {/* SECTION 2 */}
      <section className="bg-neutral-200 text-black grid place-content-center h-screen sticky top-0 rounded-tr-[3rem] rounded-tl-[3rem] overflow-hidden shadow-2xl z-10">
        <div className="absolute inset-0 [background-image:linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] [background-size:54px_54px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]"></div>
      ...
      {/* SECTION 3 */}
      <section className="text-white h-screen w-full bg-slate-950 grid place-content-center sticky top-0 overflow-hidden z-20">
        <div className="absolute inset-0 [background-image:linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] [background-size:54px_54px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]"></div>
