...
export default function ScrollStory() {
  return (
    <div className="relative">
      ...
      {/* SECTION 2 */}
      <section className="bg-secondary text-secondary-foreground grid place-content-center h-screen sticky top-0 rounded-tr-[3rem] rounded-tl-[3rem] overflow-hidden shadow-[0_-20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_-20px_50px_rgba(0,0,0,0.5)] z-20">
      ...
      {/* SECTION 3 */}
      <section className="text-foreground h-screen w-full bg-background grid place-content-center sticky top-0 rounded-tr-[3rem] rounded-tl-[3rem] overflow-hidden shadow-[0_-20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_-20px_50px_rgba(0,0,0,0.5)] z-30">
        <div className="absolute inset-0 dark:[background-image:linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] [background-image:linear-gradient(to_right,#e5e5e5_1px,transparent_1px),linear-gradient(to_bottom,#e5e5e5_1px,transparent_1px)] [background-size:54px_54px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none"></div>
